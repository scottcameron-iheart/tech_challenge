Create a React application that displays a table of song information and metrics. The user should be able to sort the order of songs by the various columns.
